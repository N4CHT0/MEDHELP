  ...
  return (
    ...
    <ScrollView>
        ...
        <View style={{flexDirection: 'row',gap:170, padding: 20}}>
            <Text style={{fontFamily: fontType['NS-SemiBold'],fontSize: 18}}>{selectedData?.title}</Text>
            <Text style={{fontFamily: fontType['NS-SemiBold'],fontSize: 18}}>{selectedData?.price}</Text>
        </View>
